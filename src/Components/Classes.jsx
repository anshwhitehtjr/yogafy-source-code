         ...
         <div className="container my-3">
            <nav>
               <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  <button class="nav-link" id="nav-upcomginclasses-tab" data-bs-toggle="tab" data-bs-target="#nav-upcomginclasses" type="button" role="tab" aria-controls="nav-upcomginclasses" aria-selected="false">Upcoming Classes</button>
               </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
               ...
               <div class="tab-pane fade" id="nav-upcomginclasses" role="tabpanel" aria-labelledby="nav-upcomginclasses-tab">
